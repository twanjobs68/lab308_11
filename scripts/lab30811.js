...
// console.log(`OH NO!!! I'm over my budget!!fuelExpenseCoveredMy balance after purchasing gas is ${balanceOfmoneyLeftB}.`);
...
if (overBudget) {
  ...
  console.log("I'm within my budget!!", fuelExpenseCovered);
